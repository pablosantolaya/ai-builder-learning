...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "filename": {
                    "type": "string",
                    "description": "The filename to write, e.g. 'tip_calc.txt'."
                },
                "content": {
                    "type": "string",
    ...
    },
    {
        "name": "think",
        "description": (
            "Use this tool to think through a problem before acting. "
            "Write out your reasoning step by step. "
            "This does not produce any output — it just helps you plan."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
